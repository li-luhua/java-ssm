...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        <form action="${path }/motorcade/update.do" method="post" class="form-horizontal" role="form">
            <input name="id" type="hidden2" value="${entity.id}">
            <fieldset>
                <legend>车队基本信息</legend>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="mot_name">车队名称</label>
                    <div class="col-sm-4">
                        <input id="mot_name" class="form-control" type="text" name="mot_name" value="${entity.mot_name}"/>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input class="form-control" type="text" name="mot_fax" value="${entity.mot_fax}"/>
                    </div>
                    <div class="col-sm-4">
                        <label class="col-sm-2 control-label" for="ds_name" >电话</label>
                    </div>
                    <div class="col-sm-4">
                        <input class="form-control" type="text" name="mot_phone" value="${entity.mot_phone}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="ds_host">地址</label>
                    <div class="col-sm-4">
                        <input class="form-control" type="text" name="mot_site" value="${entity.mot_site}"/>
                    </div>
                    <label class="col-sm-2 control-label" for="ds_name">备注</label>
                    <div class="col-sm-4">
                        <input class="form-control" type="text" name="mot_remark" value="${entity.mot_remark}"/>
                    </div>
                </div>
            </fieldset>
               <fieldset>
